...
public class GUI extends JFrame {
    ...
    public GUI() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try {
                            ...
                            JOptionPane.showMessageDialog(
                                    rootPane,
                                    "Could not connect to Twinkly at `"
                                            + ipField.getText()
                                            + "`. Did you type the IP address right?",
                                    "Connection Error",
        ...
        //						node_1.add(node_2);
        //						node_1.add(new DefaultMutableTreeNode("UUID:
        // B66C9EF3-E6F2-48A2-B27A-A07CF8D5F3E1"));
